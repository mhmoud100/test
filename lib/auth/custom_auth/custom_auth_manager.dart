...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    selfServiceBlueThemeAuthUserSubject.add(
      SelfServiceBlueThemeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SelfServiceBlueThemeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SelfServiceBlueThemeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SelfServiceBlueThemeAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    selfServiceBlueThemeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SelfServiceBlueThemeAuthUser? currentUser;
