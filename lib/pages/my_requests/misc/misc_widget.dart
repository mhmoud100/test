...
class MiscWidget extends StatefulWidget {
  ...
  @override
  State<MiscWidget> createState() => _MiscWidgetState();
}
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: UserMiscellaneousRequestsCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserMiscellaneousRequestsResponse = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions.knowIfIsList(
                              stackUserMiscellaneousRequestsResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 15.0),
                              child: Builder(
                                builder: (context) {
                                  final gitMiscellaneousRequest = getJsonField(
                                    stackUserMiscellaneousRequestsResponse
                                        .jsonBody,
                                    r'''$.message''',
                                  ).toList();
                                  ...
                                  return Column(
                                    ...
                                    children: List.generate(
                                        gitMiscellaneousRequest.length,
                                        (gitMiscellaneousRequestIndex) {
                                      final gitMiscellaneousRequestItem =
                                          gitMiscellaneousRequest[
                                              gitMiscellaneousRequestIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            10.0, 15.0, 10.0, 10.0),
                          ...
                          if (functions.knowIfIsList(
                                  stackUserMiscellaneousRequestsResponse
                                      .jsonBody)
                              ? (UserMiscellaneousRequestsCall.miscellaneous(
                                    stackUserMiscellaneousRequestsResponse
                                        .jsonBody,
                                  )?.length ==
                                  0)
