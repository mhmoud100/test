...
import '/pages/componets/privacy/privacy_policy/privacy_policy_widget.dart';
...
class _WelcomePageCopyWidgetState extends State<WelcomePageCopyWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.currentVersion = await actions.getCurrentVersion();
      _model.versionNumber = _model.currentVersion;
      safeSetState(() {});
    });
  }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/Slogan-talentio.png',
                                  width: MediaQuery.sizeOf(context).width * 1.0,
                                  height:
                                    ...
                                    builder: (context) => FFButtonWidget(
                                      onPressed: () async {
                                        if (FFAppState().policy) {
                                          ...
                                          await showDialog(
                                            barrierColor: const Color(0x19000000),
                                            context: context,
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '5fumnc2z' /* Powered By Golive-Solutions */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                                          .override(
