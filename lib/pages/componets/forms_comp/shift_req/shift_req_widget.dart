...
import 'shift_req_model.dart';
export 'shift_req_model.dart';

class ShiftReqWidget extends StatefulWidget {
  const ShiftReqWidget({super.key});

  @override
  State<ShiftReqWidget> createState() => _ShiftReqWidgetState();
}

class _ShiftReqWidgetState extends State<ShiftReqWidget>
    with TickerProviderStateMixin {
  late ShiftReqModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShiftReqModel());
      ...
      builder: (context) => Padding(
        ...
        child: FutureBuilder<ApiCallResponse>(
          ...
          builder: (context, snapshot) {
            ...
            final stackShiftTypesResponse = snapshot.data!;
            ...
            return InkWell(
              ...
              onTap: () async {
                FFAppState().errors = functions.jsonToErrors(
                    stackShiftTypesResponse.jsonBody,
                    stackShiftTypesResponse.statusCode.toString());
                safeSetState(() {});
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    if (ShiftTypesCall.message(
                                  stackShiftTypesResponse.jsonBody,
                                ) !=
                                null &&
                            (ShiftTypesCall.message(
                              stackShiftTypesResponse.jsonBody,
                            ))!
                                .isNotEmpty
                        ? (ShiftTypesCall.message(
                                        ...
                                        children: [
                                          FlutterFlowDropDown<String>(
                                            ...
                                            options: List<String>.from(
                                                ShiftTypesCall.reason(
                                              stackShiftTypesResponse.jsonBody,
                                            )!),
                                            optionLabels:
                                                functions.makeListShiftType(
                                                    ShiftTypesCall.message(
                                              stackShiftTypesResponse.jsonBody,
                                            )!
                                                        .toList()),
