...
import 'attandance_req_model.dart';
export 'attandance_req_model.dart';

class AttandanceReqWidget extends StatefulWidget {
  const AttandanceReqWidget({
    super.key,
    this.dateFromMissingAttand,
  });

  final String? dateFromMissingAttand;

  @override
  State<AttandanceReqWidget> createState() => _AttandanceReqWidgetState();
}

class _AttandanceReqWidgetState extends State<AttandanceReqWidget> {
  late AttandanceReqModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttandanceReqModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.fromDate = widget.dateFromMissingAttand;
      safeSetState(() {});
      _model.toDate = widget.dateFromMissingAttand;
      safeSetState(() {});
      _model.halfDayDate = widget.dateFromMissingAttand;
      safeSetState(() {});
    });
    ...
    return Builder(
      builder: (context) => Padding(
        ...
        child: FutureBuilder<ApiCallResponse>(
          future: AttendanceReasonCall.call(
          ...
          builder: (context, snapshot) {
            ...
            final stackAttendanceReasonResponse = snapshot.data!;
            ...
            return InkWell(
              ...
              onTap: () async {
                FFAppState().errors = functions.jsonToErrors(
                    stackAttendanceReasonResponse.jsonBody,
                    stackAttendanceReasonResponse.statusCode.toString());
                safeSetState(() {});
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    if (AttendanceReasonCall.reasonFromAttendance(
                                  stackAttendanceReasonResponse.jsonBody,
                                ) !=
                                null &&
                            (AttendanceReasonCall.reasonFromAttendance(
                              stackAttendanceReasonResponse.jsonBody,
                            ))!
                                .isNotEmpty
                        ? (AttendanceReasonCall.reasonFromAttendance(
