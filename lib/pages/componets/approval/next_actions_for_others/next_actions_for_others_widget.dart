...
import 'next_actions_for_others_model.dart';
export 'next_actions_for_others_model.dart';

class NextActionsForOthersWidget extends StatefulWidget {
  const NextActionsForOthersWidget({
    super.key,
  ...
  @override
  State<NextActionsForOthersWidget> createState() =>
      _NextActionsForOthersWidgetState();
}

class _NextActionsForOthersWidgetState
    extends State<NextActionsForOthersWidget> {
  late NextActionsForOthersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NextActionsForOthersModel());
  }
