...
import 'trainings_model.dart';
export 'trainings_model.dart';
...
class _TrainingsWidgetState extends State<TrainingsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrainingsModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: UserTrainingREQCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserTrainingREQResponse = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions.knowIfIsList(
                              stackUserTrainingREQResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 40.0),
                              child: Builder(
                                builder: (context) {
                                  final gitTrainingRequest = getJsonField(
                                    stackUserTrainingREQResponse.jsonBody,
                                    r'''$.message''',
                                  ).toList();
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(gitTrainingRequest.length,
                                            (gitTrainingRequestIndex) {
                                      final gitTrainingRequestItem =
                                          gitTrainingRequest[
                                              gitTrainingRequestIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
