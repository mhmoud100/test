...
import 'my_team_page_model.dart';
export 'my_team_page_model.dart';

class MyTeamPageWidget extends StatefulWidget {
  const MyTeamPageWidget({super.key});

  @override
  State<MyTeamPageWidget> createState() => _MyTeamPageWidgetState();
}

class _MyTeamPageWidgetState extends State<MyTeamPageWidget> {
  late MyTeamPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyTeamPageModel());
          ...
          child: Builder(
            builder: (context) => FutureBuilder<ApiCallResponse>(
              ...
              builder: (context, snapshot) {
                ...
                final stackMyTeamResponse = snapshot.data!;
                ...
                return InkWell(
                  ...
                  onTap: () async {
                    FFAppState().errors = functions.jsonToErrors(
                        stackMyTeamResponse.jsonBody,
                        stackMyTeamResponse.statusCode.toString());
                    safeSetState(() {});
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final teamList = MyTeamCall.employees(
                                              stackMyTeamResponse.jsonBody,
                                            )?.toList() ??
                                            [];
