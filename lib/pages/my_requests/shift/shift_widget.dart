...
class _ShiftWidgetState extends State<ShiftWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShiftModel());
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserShiftReqResponse = snapshot.data!;
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions
                              .knowIfIsList(stackUserShiftReqResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 38.0),
                              child: Builder(
                                builder: (context) {
                                  final gitTrainingRequest = getJsonField(
                                    stackUserShiftReqResponse.jsonBody,
                                    r'''$.message''',
                                  ).toList();
