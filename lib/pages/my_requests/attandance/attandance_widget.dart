...
import 'attandance_model.dart';
export 'attandance_model.dart';

class AttandanceWidget extends StatefulWidget {
  const AttandanceWidget({super.key});

  @override
  State<AttandanceWidget> createState() => _AttandanceWidgetState();
}

class _AttandanceWidgetState extends State<AttandanceWidget> {
  late AttandanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AttandanceModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: UserAttendanceREQCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserAttendanceREQResponse = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions.knowIfIsList(
                              stackUserAttendanceREQResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 15.0),
                              child: Builder(
                                builder: (context) {
                                  final gitAttendanceReq = getJsonField(
                                    stackUserAttendanceREQResponse.jsonBody,
                                    r'''$.message''',
                                  ).toList();
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(gitAttendanceReq.length,
                                            (gitAttendanceReqIndex) {
                                      final gitAttendanceReqItem =
                                          gitAttendanceReq[
                                              gitAttendanceReqIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            ...
                                            child: Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Text(
                                                  () {
                                                    if (functions.knowIfIsList(
                                                        stackUserAttendanceREQResponse
                                                            .jsonBody)) {
