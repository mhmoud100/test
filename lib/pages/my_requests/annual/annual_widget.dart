...
class _AnnualWidgetState extends State<AnnualWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().drawer = 0;
      safeSetState(() {});
      await GetStatusTransactionsCall.call(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserAnnualREQResponse = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions.knowIfIsList(
                              stackUserAnnualREQResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 15.0),
                              child: Builder(
                                builder: (context) {
                                  final gitAnnualRequest = getJsonField(
                                    stackUserAnnualREQResponse.jsonBody,
                                    r'''$.message''',
                                  ).toList();
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(gitAnnualRequest.length,
                                            (gitAnnualRequestIndex) {
                                      final gitAnnualRequestItem =
                                          gitAnnualRequest[
                                              gitAnnualRequestIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                          ...
                          if (functions.knowIfIsList(
                                  stackUserAnnualREQResponse.jsonBody)
                              ? (UserAnnualREQCall.requestAnnual(
                                    stackUserAnnualREQResponse.jsonBody,
                                  )?.length ==
                                  0)
                              : true)
