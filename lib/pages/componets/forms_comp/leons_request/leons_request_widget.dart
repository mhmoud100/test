...
import 'leons_request_model.dart';
export 'leons_request_model.dart';

class LeonsRequestWidget extends StatefulWidget {
  const LeonsRequestWidget({super.key});

  @override
  State<LeonsRequestWidget> createState() => _LeonsRequestWidgetState();
}

class _LeonsRequestWidgetState extends State<LeonsRequestWidget>
    with TickerProviderStateMixin {
  late LeonsRequestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeonsRequestModel());
      ...
      builder: (context) => Padding(
        ...
        child: FutureBuilder<ApiCallResponse>(
          ...
          builder: (context, snapshot) {
            ...
            final stackLoanTypesResponse = snapshot.data!;
            ...
            return InkWell(
              ...
              onTap: () async {
                FFAppState().errors = functions.jsonToErrors(
                    stackLoanTypesResponse.jsonBody,
                    stackLoanTypesResponse.statusCode.toString());
                safeSetState(() {});
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    if (LoanTypesCall.loanTypes(
                                  stackLoanTypesResponse.jsonBody,
                                ) !=
                                null &&
                            (LoanTypesCall.loanTypes(
                              stackLoanTypesResponse.jsonBody,
                            ))!
                                .isNotEmpty
                        ? (LoanTypesCall.loanTypes(
                                        ...
                                        Padding(
                                          ...
                                          child: FlutterFlowDropDown<String>(
                                            ...
                                            options: [
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'e5oxfbkf' /* Repay Fixed Amount per Period */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'r5ucpzn3' /* Repay Over Number of Periods */,
                                              )
                                            ],
                                            onChanged: (val) async {
                                              safeSetState(() =>
                                        ...
                                        Builder(
                                          builder: (context) => FFButtonWidget(
                                            ...
                                            options: FFButtonOptions(
                                              ...
                                              disabledColor: const Color(0x7ED9DBF1),
                                              disabledTextColor:
