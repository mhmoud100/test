...
import 'over_time_page_model.dart';
export 'over_time_page_model.dart';

class OverTimePageWidget extends StatefulWidget {
  const OverTimePageWidget({super.key});

  @override
  State<OverTimePageWidget> createState() => _OverTimePageWidgetState();
}

class _OverTimePageWidgetState extends State<OverTimePageWidget> {
  late OverTimePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OverTimePageModel());
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: UserOverTimeReqCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final stackUserOverTimeReqResponse = snapshot.data!;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (functions.knowIfIsList(
                              stackUserOverTimeReqResponse.jsonBody))
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 5.0, 0.0, 25.0),
                              child: Builder(
                                builder: (context) {
                                  final gitOverTimeRequest = getJsonField(
                                    stackUserOverTimeReqResponse.jsonBody,
                                    r'''$.message''',
                                  ).toList();
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(gitOverTimeRequest.length,
                                            (gitOverTimeRequestIndex) {
                                      final gitOverTimeRequestItem =
                                          gitOverTimeRequest[
                                              gitOverTimeRequestIndex];
                                      return Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
