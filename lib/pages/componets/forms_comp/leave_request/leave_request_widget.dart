...
class _LeaveRequestWidgetState extends State<LeaveRequestWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaveRequestModel());
      ...
      builder: (context) => Padding(
        ...
        child: FutureBuilder<ApiCallResponse>(
          ...
          builder: (context, snapshot) {
            ...
            final stackLeaveTypesResponse = snapshot.data!;
            ...
            return InkWell(
              ...
              onTap: () async {
                FFAppState().errors = functions.jsonToErrors(
                    stackLeaveTypesResponse.jsonBody,
                    stackLeaveTypesResponse.statusCode.toString());
                safeSetState(() {});
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    if (LeaveTypesCall.leaveTypes(
                                  stackLeaveTypesResponse.jsonBody,
                                ) !=
                                null &&
                            (LeaveTypesCall.leaveTypes(
                              stackLeaveTypesResponse.jsonBody,
                            ))!
                                .isNotEmpty
                        ? (LeaveTypesCall.leaveTypes(
                      ...
                      Align(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final containerTransactionStatsResponse =
                                snapshot.data!;
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child:
                                                  ...
                                                  controller: _model
                                                          .leavestypeValueController ??=
                                                      FormFieldController<
                                                          String>(
                                                    _model.leavestypeValue ??=
                                                        getJsonField(
                                                      containerTransactionStatsResponse
                                                          .jsonBody,
                                                      r'''$.message[0].name''',
                                                    ).toString(),
                                                  ),
                                                  options: (getJsonField(
                                                    stackLeaveTypesResponse
                                                        .jsonBody,
                                                    r'''$.message[:].name''',
                                                    true,
                                                  ) as List)
                                                  ...
                                                  onChanged: (val) async {
                                                    safeSetState(() => _model
                                                        .leavestypeValue = val);
                                                    _model.typeBalance =
                                                        await AvailableLeaveBalanceCall
                                                            .call(
                                                      leaveType: _model
                                                          .leavestypeValue,
                                                      userId:
